...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _apis_meal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apis/meal.js */ \"./src/apis/meal.js\");\n/* harmony import */ var _template_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./template.js */ \"./src/template.js\");\n/* harmony import */ var _defaultTemplate_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./defaultTemplate.js */ \"./src/defaultTemplate.js\");\n\n/* eslint-disable import/no-cycle */\n\n\n\n\nconst search = document.getElementById('search');\nconst submit = document.getElementById('submit');\nconst mealsEl = document.getElementById('meals');\nconst resultHeading = document.getElementById('result-heading');\nconst modal = document.querySelector('.meal-details-content');\nconst recipeCloseBtn = document.getElementById('recipe-close-btn');\nconst nextBtn = document.querySelectorAll('.next-btn');\nconst prevBtn = document.querySelectorAll('.prev-btn');\nlet term = search.value;\nconst postsPerPage = 10;\n\n// Search meal and fetch data\nconst searchMeal = async (e) => {\n  e.preventDefault();\n\n  // Get search term\n  term = search.value;\n  if (term.trim() === '') return;\n  resultHeading.innerHTML = `<h2>Search results for '${term}'</h2>`;\n  mealsEl.innerHTML = '<p class=\"text-center\">Loading...</p>';\n  (0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term);\n  (0,_template_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term), mealsEl, resultHeading);\n};\n\n// Get Default Meals\nconst getDefaultMeals = () => {\n  if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)()) {\n    (0,_defaultTemplate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)(), mealsEl, resultHeading);\n  } else if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term)) {\n    (0,_template_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term), mealsEl, resultHeading);\n  }\n};\n\n// Event listeners\nsubmit.addEventListener('submit', searchMeal);\n\n// load default meals on DOM load\nwindow.addEventListener('DOMContentLoaded', getDefaultMeals);\n\nrecipeCloseBtn.addEventListener('click', () => {\n  modal.parentElement.classList.remove('showRecipe');\n});\n\nprevBtn.forEach((btn) => {\n  btn.addEventListener('click', () => {\n    (0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.handlePrevBtn)();\n    if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term)) {\n      (0,_template_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term), mealsEl, resultHeading);\n    } else if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)()) {\n      (0,_defaultTemplate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)(), mealsEl, resultHeading);\n    }\n  });\n});\n\nnextBtn.forEach((btn) => {\n  btn.addEventListener('click', () => {\n    (0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.handleNextBtn)();\n    if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term)) {\n      (0,_template_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term), mealsEl, resultHeading);\n    } else if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)()) {\n      (0,_defaultTemplate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)(), mealsEl, resultHeading);\n    }\n  });\n});\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((meals, currentPage) => {\n  const pageNumbers = [];\n  for (let i = 1; i <= Math.ceil(meals.length / postsPerPage); i += 1) {\n    pageNumbers.push(i);\n  }\n  const page = document.querySelector('.page');\n  page.innerHTML = '';\n  const ul = document.createElement('ul');\n  ul.classList.add('inline-flex');\n  pageNumbers.forEach((number) => {\n    const li = document.createElement('li');\n    li.classList.add('page-item');\n    if (number === currentPage) {\n      li.classList.add('active');\n    }\n    li.innerHTML = `<a class=\"page-link bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium\" href=\"#\">${number}</a>`;\n    li.addEventListener('click', (e) => {\n      e.preventDefault();\n      (0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.handlePageBtn)(number);\n      if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term)) {\n        (0,_template_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.searchFood)(term), mealsEl, resultHeading);\n      } else if ((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)()) {\n        (0,_defaultTemplate_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])((0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_1__.defaultFood)(), mealsEl, resultHeading);\n      }\n    });\n\n    ul.appendChild(li);\n  });\n  page.appendChild(ul);\n});\n\n\n//# sourceURL=webpack://pokedex/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _apis_meal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./apis/meal.js */ \"./src/apis/meal.js\");\n/* eslint-disable import/no-cycle */\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (searchFood, mealsEl, resultHeading) => {\n  // Change HTML\n  searchFood.then((meals) => {\n    if (meals === null) {\n      resultHeading.innerHTML = '<p>There are no search results. Try again</p>';\n      mealsEl.innerHTML = '';\n    } else {\n      mealsEl.innerHTML = meals\n        .map(\n          (meal) => `\n            <div class=\"meal\">\n              <img src=\"${meal.strMealThumb}\" alt=\"${\n  meal.strMeal\n}\" class=\"meal-img\"/>\n              <div class=\"m-4 meal-info\">\n              <div class=\"title-likes\">\n                <span class=\"font-bold meal-title\">${\n  meal.strMeal.length > 14\n    ? `${meal.strMeal.slice(0, 14)}...`\n    : meal.strMeal\n} </span>\n                <span class=\"likes\"></span>\n              </div>\n              <div class=\"comment-like\">\n                <button class=\"meal-btn\" data-mealID=\"${\n  meal.idMeal\n}\">Comments<svg class=\"meal-svg\" width=\"3\" height=\"6\" viewBox=\"0 0 3 6\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" style=\"\"><path d=\"M0 0L3 3L0 6\"></path></svg>\n                </button>\n                <i class=\"fas fa-heart\" id= ${meal.idMeal}></i>\n      \n      \n              </div>\n            </div>\n            </div>\n      \n            `,\n        )\n        .join('');\n      (0,_apis_meal_js__WEBPACK_IMPORTED_MODULE_0__.getMealsLength)();\n    }\n  });\n});\n\n\n//# sourceURL=webpack://pokedex/./src/template.js?");
